...
variable "api_keys" {
  ...
  default = {
    ...
    authelia_SMTP_USERNAME = "authelia-smtp-username"
    authelia_SMTP_PASSWORD = "authelia-smtp-password"
    authelia_SMTP_HOST = "authelia-smtp-host"
    authelia_SMTP_PORT = "authelia-smtp-port"
    authelia_SMTP_SENDER_EMAIL = "authelia-smtp-sender-email"
