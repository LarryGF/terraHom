  ...
  spec {
    ...
    source {
      ...
      helm {
        ...
        values = templatefile("${path.module}/applications/${var.name}/values.yaml",merge(var.override_values,{"namespace":var.namespace,"priority":var.priority,"storage":var.storage_definitions}))
      }
    }
